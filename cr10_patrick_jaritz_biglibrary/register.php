...
$password = hash('sha256', $user_pass);
 ...
 if( !$error ) {
  ...
  $query = "INSERT INTO user(first_name,last_name, user_email, user_pass) VALUES('$first_name','$last_name','$user_email','$user_pass')";
...
<html lang="de">
  ...
  html {
    font-size: 90%;
    background: url("./images/books-library-students-12064.jpg") no-repeat center center fixed;
